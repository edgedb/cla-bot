...
container
  .bind<ServiceSettings>(TYPES.ServiceSettings)
...
container
  .bind<AgreementsHandler>(TYPES.AgreementsHandler)
  .to(AgreementsHandler);

container.bind<TokensHandler>(TYPES.TokensHandler).to(TokensHandler);

container
  .bind<RepositoriesHandler>(TYPES.RepositoriesHandler)
  .to(RepositoriesHandler);

container
  .bind<AdministratorsHandler>(TYPES.AdministratorsHandler)
  .to(AdministratorsHandler);

container.bind<ClasHandler>(TYPES.ClasHandler).to(ClasHandler);
