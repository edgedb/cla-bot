...
export function registerEdgeDBRepositories(container: Container): void {
  container
    .bind<ClaRepository>(TYPES.ClaRepository)
    .to(EdgeDBClaRepository)
    .inSingletonScope();

  container
    .bind<CommentsRepository>(TYPES.CommentsRepository)
    .to(EdgeDBCommentsRepository)
    .inSingletonScope();

  container
    .bind<AgreementsRepository>(TYPES.AgreementsRepository)
    .to(EdgeDBAgreementsRepository)
    .inSingletonScope();

  container
    .bind<AdministratorsRepository>(TYPES.AdministratorsRepository)
    .to(EdgeDBAdministratorsRepository)
    .inSingletonScope();

  container
    .bind<RepositoriesRepository>(TYPES.RepositoriesRepository)
    .to(EdgeDBRepositoriesRepository)
    .inSingletonScope();
}
